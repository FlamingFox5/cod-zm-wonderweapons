...
SWEP.EventTable = {
[ACT_VM_DRAW] = {
{ ["time"] = 0, ["type"] = "lua", value = function(self) self:SetMainGlow(false) end, client = true, server = true},
...
{ ["time"] = 30 / 45, ["type"] = "lua", value = function(self) self:SetMainGlow(true) end, client = true, server = true},
},
[ACT_VM_THROW] = {
{ ["time"] = 1 / 45, ["type"] = "sound", ["value"] = Sound("TFA_BO3_GERSCH.Throw") },
{ ["time"] = 5 / 45, ["type"] = "lua", value = function(self) self:SetMainGlow(false) end, client = true, server = true},
},
}
