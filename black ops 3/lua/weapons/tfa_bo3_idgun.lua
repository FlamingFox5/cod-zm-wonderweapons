...
SWEP.WElements = {
	["reload_mag"] = { type = "Model", model = "models/weapons/tfa_bo3/idgun/idgun_egg.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(3.5, 1.5, 1.5), angle = Angle(180, -20, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} },
}
...
function SWEP:DrawWorldModel(...)
	...
	if tpfx_cvar:GetBool() and not bHolstering then
