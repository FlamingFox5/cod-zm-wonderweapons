...
{ ["time"] = 1 / 35, ["type"] = "lua", value = function(self, vm) self:CleanParticles() end},
},
}
...
function SWEP:DrawWorldModel(...)
	...
	self:AddDrawCallWorldModelParticle(self.WW3P_FX, PATTACH_POINT_FOLLOW, tonumber(self.WW3P_ATT), TFA.Enum.ReadyStatus[self:GetStatus()])
