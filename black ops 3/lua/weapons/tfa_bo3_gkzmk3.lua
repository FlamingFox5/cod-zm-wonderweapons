...
SWEP.Primary.Damage = nzombies and 800 or 65
...
self.Primary.Damage = self.Primary_TFA.Damage
self.Primary.ClipSize = self.Primary_TFA.ClipSize
self.Primary.MaxAmmo = self.Primary_TFA.MaxAmmo

self.Secondary_TFA.Damage = 4000
self.Secondary_TFA.ClipSize = 30
self.Secondary_TFA.MaxAmmo = 215
self.Secondary.Damage = self.Secondary_TFA.Damage
self.Secondary.ClipSize = self.Secondary_TFA.ClipSize
self.Secondary.MaxAmmo = self.Secondary_TFA.MaxAmmo
...
SWEP.Secondary.Damage = nzombies and 2000 or 200 // orb damage
